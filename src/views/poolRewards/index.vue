<template>
    <div class="app-container">
        <div class="filter-container">
            ...
            <el-select v-model="listQuery.importance" placeholder="商品类型" clearable
                style="width: 120px; margin-left: 20px;" class="filter-item">
        ...
        <el-table :key="tableKey" v-loading="listLoading" :data="list" border fit highlight-current-row
            ...
            <el-table-column label="商品购买时间" align="center">
                <template slot-scope="{row}">
            ...
            <el-table-column label="账户" align="center">
                <template slot-scope="{row}">
                    <span class="link-type" @click="handleUpdate(row)">账户2342342</span>
